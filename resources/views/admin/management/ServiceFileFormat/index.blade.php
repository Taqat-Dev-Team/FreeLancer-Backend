@extends('admin.layouts.master', ['title' => 'Service File Format Management'])


@section('toolbarTitle', 'Service File Format  Management')
@section('toolbarSubTitle', 'Management')
@section('toolbarPage', 'All Service File Format ')
@section('toolbarActions')
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold" data-bs-toggle="modal"
           data-bs-target="#addFormatModal"><i class="ki-outline ki-plus"></i> Add Format </a>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid mt-5">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text"
                               id="FormatSearchInput" class="form-control form-control-solid w-250px ps-13"
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <div id="format" class="dt-container dt-bootstrap5 dt-empty-footer">
                    <div id="" class="table-responsive">

                        <table id="formats_table" class="table table-row-bordered gy-5">
                            <thead>
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function () {
                const table = $('#formats_table').DataTable({
                    processing: true,
                    serverSide: true,
                    order: [[0, 'desc']],
                ...
                $('#applyFilters').on('click', function () {
                    $('#formats_table').DataTable().ajax.reload();
                });
                ...
                function bindActionButtons() {
                    $('.delete-format').off('click').on('click', function (e) {
                        e.preventDefault();
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    url: '/admin/service-file-format/' + id,
                                    type: 'DELETE',
                                    data: {
                                        _token: '{{ csrf_token() }}'
                                    },
                                    ...
                                    error: function (xhr) {
                                        toastr.error('Error deleting Format', xhr.responseJSON.message || 'An error occurred');
                                    }
                                });
                            }
                        });
        ...
        @include('admin.management.ServiceFileFormat.add')
        @include('admin.management.ServiceFileFormat.edit')
    @endpush
