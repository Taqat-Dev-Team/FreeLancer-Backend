            ...
            <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-center flex-column py-5">
                             ...
                             <div class="mb-9">
                                ...
                                <div class="mb-9">
                                    <div
                                        class="badge badge-lg badge-light-primary d-inline mt-1">{{ $category->name }}</div>
                                </div>

                                <!-- الشارات -->
                                <div class="fw-bold mb-3">Assigned Badges</div>
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600 mb-2">
                                        ...
                                        {{ $country->number_code . $user->mobile }}
                                    </div>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        @include('admin.FreeLancer.Index-tabs.over-view')
                        @include('admin.FreeLancer.Index-tabs.educations')
                        @include('admin.FreeLancer.Index-tabs.work')
                        @include('admin.FreeLancer.Index-tabs.summary')
                        @include('admin.FreeLancer.Index-tabs.id')
