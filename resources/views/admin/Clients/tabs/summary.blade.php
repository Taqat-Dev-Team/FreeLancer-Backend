<div class="tab-pane fade " id="kt_user_view_summary_tab" role="tabpanel">
    ...
    <div class="card card-flush mb-10">
        ...
        <div class="card-body">
            ...
            <!--begin::Post media-->
            <!-- عنوان الصور -->
            <h3 class="mb-5">{{ $client->images_title }}</h3>

            <div class="row g-7">
                @foreach($client->getImagesUrls() as $key => $image)
    ...
    @if($client->user->video)
        <div class="card card-flush mb-10">
            ...
            <div class="card-body">
                <!--begin::Post content-->
                <div
                    class="fs-6 fw-normal text-gray-700 mb-5">{{$client->user->video_title}} </div>
                <!--end::Post content-->
                <!--begin::Video-->
                @php
                    ...
                    $embedUrl = getYoutubeEmbedUrl($client->user->video);
                @endphp
